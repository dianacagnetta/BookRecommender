...
public class SelettoreLibroController {
    ...
    /**
     * Inizializza il controller e imposta un listener sul campo di testo per
     * filtrare la lista dei libri in tempo reale.
    ...
    public void setData(int libreriaId, Utente utente, LibreriaDettaglioController caller) {
        ...
        this.caller = caller;
        caricaLibri("");
        txtFiltro.textProperty().addListener((obs, oldV, newV) -> caricaLibri(newV));
    }
